...
import styles from '../Djikstra/dijkstra.module.css';
import usePathfindingGrid, { Node } from '../../../hooks/usePathfindingGrid';
import { animateBumblebeeAStar } from '../../../utils/bumblebeeAlgorithm';

const BumblebeePathfindingAStar = () => {
            ...
            <div className={styles.contentGrid}>
                ...
                <div className={styles.controlsSection}>
                    <header className={styles.header}>
                        <h1>Bumblebee Pathfinding (A*)</h1>
                        <p>Help the bumblebee find the flower using A*!</p>
                    </header>
...
export default BumblebeePathfindingAStar;
